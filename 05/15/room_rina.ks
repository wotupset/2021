...
;■正常位1
[glink  color="pink" size="15"  x="20"  width="150"  y="&tf.taii + 50"  text="正常位１"  target="*rina_room_movie" exp="tf.posture = 0"]

;■正常位2
[if exp="f.rina_h >= 10"]
 [glink  color="pink" size="15"  x="70"  width="150"  y="&tf.taii + 85"  text="正常位２"  target="*rina_room_movie" exp="tf.posture = 1"]
[endif]

;■正常位3
[if exp="f.rina_h >= 40"]
 [glink  color="pink" size="15"  x="120"  width="150"  y="&tf.taii + 120"  text="正常位3"  target="*rina_room_movie" exp="tf.posture = 8"]
[endif]

;■側位１
[glink  color="pink" size="15"  x="20"  width="150"  y="&tf.taii + 160"  text="側位１"  target="*rina_room_movie" exp="tf.posture = 2"]

;■測位２
[if exp="f.rina_h >= 30"]
 [glink  color="pink" size="15"  x="70"  width="150"  y="&tf.taii + 195"  text="側位２"  target="*rina_room_movie" exp="tf.posture = 3"]
[endif]

;■後背位１
[if exp="f.rina_h >= 20"]
 [glink  color="pink" size="15"  x="20"  width="150"  y="&tf.taii + 270"  text="後背位１"  target="*rina_room_movie" exp="tf.posture = 4"]
[endif]

;■後背位２　　
[if exp="f.rina_h >= 50"]
 [glink  color="pink" size="15"  x="70"  width="150"  y="&tf.taii + 305"  text="後背位２"  target="*rina_room_movie" exp="tf.posture = 5"]
[endif]

;■後背位3　　
[if exp="f.rina_h >= 70"]
 [glink  color="pink" size="15"  x="120"  width="150"  y="&tf.taii + 340"  text="後背位3"  target="*rina_room_movie" exp="tf.posture = 9"]
[endif]

;■騎乗位
[if exp="f.rina_h >= 60"]
 [glink  color="pink" size="15"  x="20"  width="150"  y="&tf.taii + 380"  text="騎乗位"  target="*rina_room_movie" exp="tf.posture = 6"]
[endif]

;■騎乗位2
[if exp="f.rina_h >= 85"]
 [glink  color="pink" size="15"  x="70"  width="150"  y="&tf.taii + 415"  text="騎乗位2"  target="*rina_room_movie" exp="tf.posture = 10"]
[endif]

;■立位
[if exp="f.rina_h >= 80"]
 [glink  color="pink" size="15"  x="20"  width="150"  y="&tf.taii + 455"  text="立位"  target="*rina_room_movie" exp="tf.posture = 7"]
[endif]
