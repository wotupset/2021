...
[if exp="f.day ==27 || f.day ==28"]
[glink  color="pink" size="20"  x="700"  width="400"  y="490"  text="お祭り"  target="*date_money" exp="tf.date_select = 7" ]
...
[endif]
;バイブＳ
[if exp="f.item[3] == true && f.vibrator_riko_h != 1"]
...
[if exp="f.day ==27 || f.day ==28"]
[glink  color="pink" size="20"  x="700"  width="400"  y="430"  text="お祭り"  target="*date_money" exp="tf.date_select = 7" ]
[eval exp="tf.item_y = 490"]
[endif]
;コスプレ衣装メイド服
...
[endif]
;バイブM
[if exp="f.item[4] == true && f.vibrator_rina_h != 1"]
[glink  color="pink" size="20"  x="700"  width="400"  y=&tf.item_y  text="バイブを使う"  target="*date_money" exp="tf.date_select = 9" ]
[eval exp="tf.item_y = tf.item_y + 60"]
[endif]
[s]
...
[endif]
;バイブL
[if exp="f.item[5] == true && f.vibrator_sizue_h != 1"]
[glink  color="pink" size="20"  x="700"  width="400"  y=&tf.item_y  text="バイブを使う"  target="*date_money" exp="tf.date_select = 9" ]
[eval exp="tf.item_y = tf.item_y + 60"]
[endif]
[s]
